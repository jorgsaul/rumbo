...
function VentanaTestVocacional() {
  ...
  // Función simple para categorizar empleabilidad
  const categorizarEmpleabilidad = (porcentaje) => {
    if (porcentaje === undefined || porcentaje === null) return "No disponible";
    if (porcentaje >= 85) return "Muy Alta";
              ...
              <div key={carrera.id} className="vtv-carrera">
                ...
                <div className="vtv-carrera-info">
                  ...
                  <div className="vtv-info-row">
                    ...
                    {categorizarEmpleabilidad(carrera.profesion?.empleabilidad)}
                  </div>
                  <div className="vtv-info-row">
