...
function VentanaResultados() {
  ...
  useEffect(() => {
    const fetchDatos = async () => {
      try {
        const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/obtener-resultados`, {
          credentials: 'include',
          method: 'GET'
        })
  ...
  return(
    <div>
      ...
      {datos === null || datos.length === 0 ? ( 
        ...
        <>
        <p>Continua haciendo tests para mejorar la grafica de tus resultados.</p>
